...
// Definición de las páginas con sus descripciones y rutas
  ...
  return (
    <section>
      <div className="px-4 py-8 mx-auto lg:px-6 sm:py-16 lg:py-24">
       {/* Componente de título para la sección */}
        <Titulo 
        ...
        />
           {/* Grid de distribuciones de Linux */}
        <div className="grid grid-cols-1 mt-12 text-center sm:mt-16 gap-x-20 gap-y-12 sm:grid-cols-2 lg:grid-cols-3">
          {
            paginas.map((pagina) => (
              <div key={pagina.url} className="space-y-4">
                ...
                {/* Enlace a la página de la distribución con efectos de hover */}
